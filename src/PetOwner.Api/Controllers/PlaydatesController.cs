...
public class PlaydatesController : ControllerBase
{
    ...
    public async Task<IActionResult> GetEvent(Guid id)
    {
        ...
        var e = await _db.PlaydateEvents.AsNoTracking()
            ...
            .Select(ev => new
            {
                ...
                Attendees = ev.Rsvps.Select(r => new
                {
                    ...
                    Pet = r.Pet == null ? null : new { r.Pet.Id, r.Pet.Name, Species = r.Pet.Species.ToString(), r.Pet.Breed, r.Pet.Gender, r.Pet.BirthDate, r.Pet.Age, r.Pet.ImageUrl, r.Pet.DogSize, r.Pet.Sterilization, r.Pet.TagsCsv }
                }).ToList()
            })
            .FirstOrDefaultAsync();
        ...
        var attendees = e.Attendees.Select(a => new PlaydateAttendeeDto(
            ...
            a.Pet == null ? null : new PalPetDto(a.Pet.Id, a.Pet.Name, a.Pet.Species, a.Pet.Breed,
                a.Pet.Gender == PetGender.Unknown ? null : a.Pet.Gender.ToString(),
                PetAgeHelper.CalculateAge(a.Pet.BirthDate, a.Pet.Age), a.Pet.ImageUrl,
