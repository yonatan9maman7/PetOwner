...
const CODE_TO_KEY: Record<string, TranslationKey> = {
  ...
  INVALID_PHONE: "registerPhoneInvalidFormat",
...
const MESSAGE_SUBSTRINGS: { needle: string; key: TranslationKey }[] = [
  ...
  { needle: "invalid phone number format", key: "registerPhoneInvalidFormat" },
  { needle: "please enter a valid phone number", key: "registerPhoneInvalidFormat" },
