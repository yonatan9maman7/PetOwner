          ...
          <div>
            ...
            <div
              ...
              <input
                ...
                [ngClass]="
                  isRegister()
                    ? 'w-full rounded-xl border border-gray-300 bg-white py-2 ps-3 pe-12 text-start text-sm text-gray-900 placeholder:text-start placeholder:text-gray-400 transition focus:border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-500'
                    : 'w-full rounded-xl border border-gray-300 bg-white py-3 ps-4 pe-12 text-start text-gray-900 placeholder:text-start placeholder:text-gray-400 transition focus:border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-500'
                "
              />
              <button
                type="button"
