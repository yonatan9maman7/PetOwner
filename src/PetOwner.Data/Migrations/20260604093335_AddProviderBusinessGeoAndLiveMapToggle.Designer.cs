...
namespace PetOwner.Data.Migrations
{
    ...
    [Migration("20260604093335_AddProviderBusinessGeoAndLiveMapToggle")]
    partial class AddProviderBusinessGeoAndLiveMapToggle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetOwner.Data.Models.BookingPet", b =>
                {
            ...
            modelBuilder.Entity("PetOwner.Data.Models.CommunityReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("PetOwner.Data.Models.CommunitySavedPost", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PetOwner.Data.Models.CommunitySosSighting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("CommunitySosSightings");
                });
            ...
            modelBuilder.Entity("PetOwner.Data.Models.DogPark", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("PetOwner.Data.Models.DogParkCheckIn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("PetOwner.Data.Models.GroupMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PetOwner.Data.Models.PlaydateEvent", b =>
                {
                    ...
                    b.Property<string>("AgeFilterCsv")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<Guid?>("LinkedCommunityGroupId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MeetupVisibility")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                    ...
                    b.Property<bool>("VaccinatedOnly")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("LinkedCommunityGroupId");
            ...
            modelBuilder.Entity("PetOwner.Data.Models.Post", b =>
                {
                    ...
                    b.Property<Guid?>("RelatedPetId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("SosNotifyRadiusKm")
                        .HasColumnType("int");

                    b.Property<DateTime?>("SosResolvedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("PetOwner.Data.Models.PostHelpfulMark", b =>
                {
                    b.Property<Guid>("PostId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PetOwner.Data.Models.ProviderProfile", b =>
                {
                    ...
                    b.Property<Point>("BusinessGeoLocation")
                        .HasColumnType("geography");
                    ...
                    b.Property<bool>("UseLiveLocationOnMap")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("PetOwner.Data.Models.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("FinancialDecision")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("PetOwner.Data.Models.UserCommunityPrefs", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("AllowMeetupInvites")
                        .HasColumnType("bit");

                    b.Property<string>("DmPolicy")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                    ...
                    b.Property<bool>("ShowDogInCommunity")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PetOwner.Data.Models.CommunityReport", b =>
                {
                    b.HasOne("PetOwner.Data.Models.User", "Reporter")
            ...
            modelBuilder.Entity("PetOwner.Data.Models.PlaydateEvent", b =>
                {
                    ...
                    b.HasOne("PetOwner.Data.Models.CommunityGroup", "LinkedCommunityGroup")
                        .WithMany()
                        .HasForeignKey("LinkedCommunityGroupId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Host");

                    b.Navigation("LinkedCommunityGroup");
                });
            ...
            modelBuilder.Entity("PetOwner.Data.Models.SupportTicket", b =>
                {
                    b.HasOne("PetOwner.Data.Models.ServiceRequest", "Booking")
            ...
            modelBuilder.Entity("PetOwner.Data.Models.UserCommunityPrefs", b =>
                {
                    b.HasOne("PetOwner.Data.Models.User", "User")
                        .WithOne("CommunityPrefs")
                        .HasForeignKey("PetOwner.Data.Models.UserCommunityPrefs", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PetOwner.Data.Models.Pet", b =>
                {
                    ...
                    b.Navigation("DogParkCheckIns");

                    b.Navigation("MedicalRecords");

                    b.Navigation("RelatedCommunityPosts");
